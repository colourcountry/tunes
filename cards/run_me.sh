...
python ./formatter.py -S - < easy.ids
...
python ./formatter.py -S -C - < main.ids
lilypond -o out/out out/tunes0.ly
...
python ./formatter.py -p preamble.crib.ly.fragment -c - < crib.ids
lilypond -o out/out out/tunes0.ly
pdfnup --nup 1x4 --no-landscape --suffix crib out/out.pdf

# Stitch up with front page of original tune book

pdfjam out-easy.pdf out-main.pdf out-crib.pdf -o out.pdf
